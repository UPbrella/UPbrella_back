...
class StoreControllerTest : RestDocsSupport() {
    ...
    fun findCurrentUmbrellaStoreTest() {
        ...
        mockMvc.perform(
            ...
            .andDo(
                document(
                    "store-find-current-umbrella-store-doc",
                    getDocumentRequest(),
                    getDocumentResponse(),
                    pathParameters(
    ...
    fun updateStoreTest() {
        ...
        // when & then
        mockMvc.perform(
            patch("/admin/stores/{storeId}", storeId)
                .content(objectMapper.writeValueAsString(store))
                .contentType(MediaType.APPLICATION_JSON)
        )
            .andExpect(status().isOk)
    ...
    fun uploadStorageImages() {
        ...
        // when & then
        mockMvc.perform(
            multipart("/admin/stores/{storeId}/images", 1L)
                .file(firstFile)
    ...
    fun deleteStoreImagesTest() {
        ...
        // when & then
        mockMvc.perform(
            delete("/admin/stores/images/{imageId}", imageId)
        )
            .andExpect(status().isOk)
            .andDo(print())
            .andDo(
                document(
                    "store-delete-images-doc",
                    getDocumentRequest(),
                    getDocumentResponse(),
                    pathParameters(
    ...
    fun deleteStoreTest() {
        ...
        // when & then
        mockMvc.perform(
            delete("/admin/stores/{storeId}", storeMetaId)
        )
            .andExpect(status().isOk)
            .andDo(print())
            .andDo(
    ...
    fun findAllClassificationTest() {
        ...
        // when & then
        mockMvc.perform(
            get("/stores/classifications")
        )
            .andExpect(status().isOk)
            .andDo(print())
            .andDo(
                document(
                    "store-find-all-classification-doc",
                    getDocumentRequest(),
                    getDocumentResponse(),
                    responseFields(
                        beneathPath("data").withSubsectionId("data"),
    ...
    fun createClassificationTest() {
        ...
        // when & then
        mockMvc.perform(
            post("/admin/stores/classifications")
            ...
            .andDo(
                document(
                    "store-create-classification-doc",
                    getDocumentRequest(),
                    getDocumentResponse(),
                    requestFields(
                        fieldWithPath("name").type(JsonFieldType.STRING)
    ...
    fun deleteClassificationTest() {
        ...
        // when & then
        mockMvc.perform(
            delete("/admin/stores/classifications/{classificationId}", classificationId)
        )
            .andExpect(status().isOk)
            .andDo(print())
            .andDo(
                document(
                    "store-delete-classification-doc",
                    getDocumentRequest(),
                    getDocumentResponse(),
                    pathParameters(
                        parameterWithName("classificationId")
    ...
    fun findAllSubClassificationTest() {
        ...
        // when & then
        mockMvc.perform(
            get("/stores/subClassifications")
        )
            .andExpect(status().isOk)
            .andDo(print())
            .andDo(
                document(
                    "store-find-all-sub-classification-doc",
                    getDocumentRequest(),
                    getDocumentResponse(),
                    responseFields(
                        beneathPath("data").withSubsectionId("data"),
    ...
    fun createSubClassificationTest() {
        ...
        mockMvc.perform(
            ...
            .andDo(
                document(
                    "store-create-sub-classification-doc",
                    getDocumentRequest(),
                    getDocumentResponse(),
                    requestFields(
                        fieldWithPath("name").type(JsonFieldType.STRING)
    ...
    fun deleteSubClassificationTest() {
        // given
        ...
        mockMvc.perform(
            ...
            .andDo(
                document(
                    "store-delete-sub-classification-doc",
                    getDocumentRequest(),
                    getDocumentResponse(),
                    pathParameters(
                        parameterWithName("subClassificationId")
                            .description("소분류 고유번호")
                    )
                )
            )
    ...
    fun findStoreIntroductionTest() {
        ...
        mockMvc.perform(
            ...
            .andDo(
                document(
                    "store-find-store-introduction-doc",
                    getDocumentRequest(),
                    getDocumentResponse(),
                    responseFields(
                        beneathPath("data").withSubsectionId("data"),
    ...
    fun updateActivateStatusTest() {
        ...
        mockMvc.perform(
            ...
            .andDo(
                document(
                    "store-update-activate-status-doc",
                    getDocumentRequest(),
                    getDocumentResponse(),
                    pathParameters(
                        parameterWithName("storeId").description("협업 지점 고유번호")
    ...
    fun inactivateStoreStatus() {
        ...
        mockMvc.perform(
            ...
            .andDo(
                document(
                    "store-update-inactivate-status-doc",
                    getDocumentRequest(),
                    getDocumentResponse(),
                    pathParameters(
                        parameterWithName("storeId").description("협업 지점 고유번호")
    ...
    fun findAllBusinessHours() {
        ...
        mockMvc.perform(
            ...
            .andDo(
                document(
                    "store-find-all-business-hours-doc",
                    getDocumentRequest(),
                    getDocumentResponse(),
                    pathParameters(
                        parameterWithName("storeId").description("협업 지점 고유번호")
